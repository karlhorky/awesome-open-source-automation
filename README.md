...
- [Next.js CodeSandbox reproduction template](https://codesandbox.io/p/sandbox/github/vercel/next.js/tree/canary/examples/reproduction-template)
...
- Vue Test Utils Reproduction Template
...
- Ant Design reproduction template
  - [repro template on CodeSandbox](https://codesandbox.io/s/antd-reproduction-template-forked-jyh2k9)
  - [Link to docs](https://ant-design-3x.gitee.io/docs/react/getting-started#1.-Create-one-codesandbox:~:text=Visit%20http%3A//u.ant.design/codesandbox%2Drepro%20to%20create%20a%20codesandbox.%20Don%27t%20forget%20to%20press%20the%20save%20button.)
